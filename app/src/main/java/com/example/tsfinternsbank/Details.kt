...
import com.example.tsfinternsbank.databinding.ActivityDetailsBinding
...
//        setContentView(R.layout.activity_detail)
        ...
        val adapter = ArrayAdapter<String>(this@Details, androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,list)
        binding.spinner.adapter = adapter

        binding.spinner.onItemSelectedListener = object  : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(adapterView: AdapterView<*>?, view: View?, position: Int, id: Long) {
                Toast.makeText(this@Details, "you Selected ${adapterView?.getItemAtPosition(position).toString()}",
        ...
        var helper = DbHelper(this@Details)
